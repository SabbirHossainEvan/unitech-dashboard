...
const FilterSearchSection = ({ onSearch, onReset }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 ">
      ...
      <button
        onClick={handleReset}
        className="w-full bg-white text-gray-700 py- px-4 border border-gray-300 rounded-md text-base font-semibold hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-200 focus:ring-opacity-75 transition duration-150 ease-in-out flex items-center justify-center space-x-2"
      >
